  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl p-8 space-y-8">
      ...
      <div className="flex items-center gap-3 p-4 bg-purple-50 rounded-lg border border-purple-100">
        ...
        <label
          htmlFor="bonus"
          className="text-lg text-purple-900 cursor-pointer select-none"
        >
      ...
      <div className="bg-gray-50 p-4 rounded-lg text-sm text-gray-600">
        <strong>שים לב:</strong> השאלות במבדק הראשי הן שאלות אמריקאיות. שאלות
        הבונוס הן שאלות פתוחות.
      </div>

      <button
        onClick={() =>
          onStart({ questionCount, textLength, topic, includeBonus })
        }
